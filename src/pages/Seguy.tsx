...
import { MapPin, Calendar, Users, AlertTriangle, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <section className="py-16 px-6 bg-slate-800/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a 
            href="https://customer-assets.emergentagent.com/job_cnrd-preview/artifacts/m2l3rsn3_Seguy_p30-31_%20conf%C3%A9rence%2013%20mai%201945.pdf"
            target="_blank"
          ...
          >
            ...
            <span className="text-lg font-medium">Télécharger le témoignage de Georges Séguy</span>
          </a>
        </div>
      </section>
